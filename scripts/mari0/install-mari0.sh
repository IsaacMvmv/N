...
if [ -f /bin/apt ];then
	sudo apt install -y gcc g++ make git libluajit-5.1-2 libluajit-5.1-dev sdl2 libopenal libopenal-dev libsdl2-dev libsdl2 libfreetype6 libfreetype6-dev libmpg123-0 libvorbis-dev libmpg123-dev
