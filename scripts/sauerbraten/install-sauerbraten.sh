...
if [ -f /usr/bin/apt ];then
	sudo apt install -y wget git make gcc g++ libsdl2-2.0-0 libsdl2-dev libsdl2-mixer-dev libsdl2-image-dev 
elif [ -f /usr/bin/pacman ];then
	sudo pacman -S --needed wget git make gcc sdl2 sdl2_mixer sdl2_image
fi
